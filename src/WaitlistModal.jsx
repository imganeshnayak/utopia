...
const WaitlistModal = ({ isOpen, onClose, initialTab = "customer" }) => {
  ...
  return (
    <div
      className={`waitlist-modal fixed inset-0 z-[100] flex items-center justify-center p-4 ${
        isOpen ? "modal-open" : ""
      }`}
    >
      {/* Backdrop */}
      ...
      {/* Modal Content */}
      <div className="modal-content relative w-full max-w-lg bg-zinc-950 border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl">
        {/* Close Button */}
        <button
          onClick={handleClose}
        ...
        <div className="pt-8 pb-4 px-6 text-center border-b border-zinc-800">
          ...
          <div className="flex gap-2 mt-6 bg-zinc-900 p-1 rounded-xl border border-zinc-800">
            <button
              ...
              className={`tab-btn flex-1 px-4 py-2 rounded-lg text-sm font-medium text-zinc-400 flex items-center justify-center gap-2 ${
          ...
          {activeTab === "customer" && !showSuccess && (
            <div className="tab-content active">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <button
                  type="submit"
                  className="w-full bg-white hover:bg-zinc-200 text-zinc-950 px-6 py-3 rounded-xl text-sm font-medium transition-all flex items-center justify-center gap-2"
                >
          ...
          {showSuccess && (
            <div className="tab-content active">
              <div className="text-center py-8">
                ...
                <button
                  onClick={handleClose}
                  className="bg-white hover:bg-zinc-200 text-zinc-950 px-6 py-3 rounded-xl text-sm font-medium transition-all"
                >
                  Got it, thanks!
                </button>
              </div>
